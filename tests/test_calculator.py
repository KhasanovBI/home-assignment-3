...
class CalculatorTestCase(unittest.TestCase):
    ...
    def test_subtract_of_floats(self):
        self.assertAlmostEqual(self.calculator.subtract(5.3, 1.2), 4.1)
    ...
    def test_multiply_of_int_and_float(self):
        self.assertAlmostEqual(self.calculator.multiply(12, 0.1), 1.2)
    ...
    def test_multiply_of_floats(self):
        self.assertAlmostEqual(self.calculator.multiply(5.2, 1.2), 6.24)

    def test_commutativity_of_multiply_of_floats(self):
        self.assertAlmostEqual(self.calculator.multiply(1.2, 5.23), self.calculator.multiply(5.23, 1.2))
    ...
    def test_divide_of_floats(self):
        self.assertAlmostEqual(self.calculator.divide(0.3, 0.1), 3)
